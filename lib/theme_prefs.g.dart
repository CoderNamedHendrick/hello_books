...
class ThemePrefsCompanion extends UpdateCompanion<ThemePref> {
  ...
  ThemePrefsCompanion copyWith(
      {Value<int>? themeId, Value<String>? themeName}) {
    return ThemePrefsCompanion(
      themeId: themeId ?? this.themeId,
      themeName: themeName ?? this.themeName,
    );
...
class $ThemePrefsTable extends ThemePrefs
  ...
  @override
  late final GeneratedIntColumn themeId = _constructThemeId();
  ...
  @override
  late final GeneratedTextColumn themeName = _constructThemeName();
